...
/* harmony import */ var _components_upload_file__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/upload-file */ "./src/app/components/upload-file.ts");
/* harmony import */ var _components_import_progress__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/import-progress */ "./src/app/components/import-progress.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_upload_file__WEBPACK_IMPORTED_MODULE_5__["UploadFileComponent"],
                _components_import_progress__WEBPACK_IMPORTED_MODULE_6__["ImportProgressComponent"]
            ],
            imports: [
...
/***/ "./src/app/components/import-progress.ts":
/*!***********************************************!*\
  !*** ./src/app/components/import-progress.ts ***!
  \***********************************************/
/*! exports provided: ImportProgressComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ImportProgressComponent", function() { return ImportProgressComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var ImportProgressComponent = /** @class */ (function () {
    function ImportProgressComponent(electronService, changeDetectorRef) {
        var _this = this;
        this.electronService = electronService;
        this.changeDetectorRef = changeDetectorRef;
        this.onProgressChanged$ = new _angular_core__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"]();
        this.electronService.ipcRenderer.on('progressChanged', function (sender, data) {
            console.log('progressChanged', data);
            _this.onProgressChanged$.next(data);
            _this.changeDetectorRef.detectChanges();
        });
    }
    ImportProgressComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
...
/***/ "./src/app/components/upload-file.ts":
/*!*******************************************!*\
  !*** ./src/app/components/upload-file.ts ***!
  \*******************************************/
...
var UploadFileComponent = /** @class */ (function () {
    function UploadFileComponent(electronService) {
        this.electronService = electronService;
    }
...
module.exports = __webpack_require__(/*! D:\angular-electron\client\src\main.ts */"./src/main.ts");
